...
func parseErrorCheck(code: Int, uiViewController: UIViewController) {
    var output:String = ""
    switch (code) {
    case 0:
        //nel caso in cui username o password siano errati
        output = "Username o Password errati!"
        break;
    case 1:
    ...
    let alert = UIAlertController(title: "Attenzione!", message: output, preferredStyle: UIAlertControllerStyle.Alert)
